...
public abstract class Polygon {
	...
	public Polygon(int n) {
		assert n > 2;
		setNumSides(n);
		setAspectCalculator(createAspectCalculator());
	}
	...
	public Polygon(int n, double maxWidth, double maxHeight) {
		...
		updateSize(n, maxWidth, maxHeight);
	}
	
	public void updateSize(double width, double height) {
		updateSize(getNumSides(), width, height);
	}
		
		public void updateSize(int n, double width, double height) {
		resizeBounds(n, width, height);
	...
	public abstract AspectCalculator createAspectCalculator();
	...
	public double getAspectRatio() {
		assert aspectCalculator != null;
		return aspectCalculator.aspectRatio();
	}
	...
	public void resizeBounds(double maxWidth, double maxHeight) {
		resizeBounds(getNumSides(), maxWidth, maxHeight);
	}
	...
	public double radius(double width, double height) {
		return radius(getNumSides(), width, height);
	}
